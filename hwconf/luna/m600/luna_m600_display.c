...
static void set_assist_level(uint8_t assist_code) {
	...
	switch (assist_code) {
		case PAS_LEVEL_WALK:	current_scale = 0.000; break;
		case PAS_LEVEL_0:		current_scale = 0.025; break;
		case PAS_LEVEL_1:		current_scale = 0.050; break;
		case PAS_LEVEL_2:		current_scale = 0.100; break;
		...
		case PAS_LEVEL_6:		current_scale = 0.350; break;
		case PAS_LEVEL_7:		current_scale = 0.500; break;
		case PAS_LEVEL_8:		current_scale = 0.700; break;
